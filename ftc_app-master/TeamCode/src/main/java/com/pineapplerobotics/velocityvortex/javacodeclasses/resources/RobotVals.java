...
public class RobotVals {
    public static final double BEACON_RIGHT_BACK = 0;
    public static final double BEACON_LEFT_BACK = .7;
    public static final double BEACON_RIGHT_FORWARD = 0.2;
    public static final double BEACON_LEFT_FORWARD = 0.5;
